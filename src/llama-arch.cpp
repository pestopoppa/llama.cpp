...
static const std::map<llm_arch, const char *> LLM_ARCH_NAMES = {
    ...
    { LLM_ARCH_DEEPSEEK41_DSPARK, "deepseek41-dspark" },
...
static const std::map<llm_kv, const char *> LLM_KV_NAMES = {
    ...
    { LLM_KV_DFLASH_NOISE_TOKEN_ID,   "%s.noise_token_id"     },
    { LLM_KV_DFLASH_DSPARK_VARIANT,   "%s.dspark_variant"     },
    ...
    { LLM_KV_DSPARK_TARGET_ARCH,        "%s.dspark.target_arch"        },
    { LLM_KV_DSPARK_TARGET_BLOCK_COUNT, "%s.dspark.target_block_count" },
...
static const std::map<llm_tensor, const char *> LLM_TENSOR_NAMES = {
    ...
    { LLM_TENSOR_DSPARK_MAIN_PROJ,                       "blk.%d.dspark_main_proj" },
    { LLM_TENSOR_DSPARK_MAIN_NORM,                       "blk.%d.dspark_main_norm" },
    { LLM_TENSOR_DSPARK_MARKOV_EMBD,                     "dspark_markov_embd" },
    { LLM_TENSOR_DSPARK_MARKOV_HEAD,                     "dspark_markov_head" },
    { LLM_TENSOR_DSPARK_CONFIDENCE_PROJ,                 "dspark_confidence_proj" },
...
static const std::map<llm_tensor, llm_tensor_info> LLM_TENSOR_INFOS = {
    ...
    {LLM_TENSOR_DSPARK_CONFIDENCE_PROJ,     {LLM_TENSOR_LAYER_OUTPUT,    GGML_OP_MUL_MAT}},
