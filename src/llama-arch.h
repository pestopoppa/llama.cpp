...
enum llm_kv {
    ...
    LLM_KV_DFLASH_NOISE_TOKEN_ID,
    LLM_KV_DFLASH_DSPARK_VARIANT,
    LLM_KV_DSPARK_BLOCK_SIZE,
    LLM_KV_DSPARK_MARKOV_RANK,
    LLM_KV_DSPARK_NOISE_TOKEN_ID,
    LLM_KV_DSPARK_TARGET_LAYER_IDS,
    LLM_KV_DSPARK_TARGET_ARCH,
    LLM_KV_DSPARK_TARGET_BLOCK_COUNT,
...
enum llm_tensor {
    ...
    LLM_TENSOR_DSPARK_MAIN_PROJ,        // deepseek41-dspark
    LLM_TENSOR_DSPARK_MAIN_NORM,        // deepseek41-dspark
    LLM_TENSOR_DSPARK_MARKOV_EMBD,      // deepseek41-dspark
    LLM_TENSOR_DSPARK_MARKOV_HEAD,      // deepseek41-dspark
    LLM_TENSOR_DSPARK_CONFIDENCE_PROJ,  // deepseek41-dspark
