...
int main(int argc, char ** argv) {
    ...
    // Load the draft model and bind it to the target context. This is required
    // by draft architectures that consume target-model hidden states.
    ...
    // Init the speculator before prompt evaluation so draft architectures can
    // consume the target prompt features through the shared process hook.
