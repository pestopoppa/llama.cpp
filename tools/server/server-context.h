...
struct server_routes {
    ...
    server_http_context::handler_t post_hidden_states;
...
private:
    ...
    std::unique_ptr<server_res_generator> handle_slots_set_beta(const server_http_req &, int id_slot);
    std::unique_ptr<server_res_generator> handle_slots_seq_rm(const server_http_req &, int id_slot);
    std::unique_ptr<server_res_generator> handle_slots_compact(const server_http_req &, int id_slot);
