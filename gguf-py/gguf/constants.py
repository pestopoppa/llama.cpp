...
MODEL_ARCH_NAMES: dict[MODEL_ARCH, str] = {
    ...
    MODEL_ARCH.DIFF_TRANSFORMER: "diff-transformer",
    ...
    MODEL_ARCH.BAILINGMOE_LINEAR: "bailingmoe-linear",
}
...
MODEL_TENSORS: dict[MODEL_ARCH, list[MODEL_TENSOR]] = {
    ...
    MODEL_ARCH.BAILINGMOE_LINEAR: [
        ...
        MODEL_TENSOR.ATTN_Q_NORM,
        MODEL_TENSOR.ATTN_K_NORM,
        MODEL_TENSOR.ATTN_GATE,        # g_proj on linear-attention layers only (Lightning Attention)
        MODEL_TENSOR.ATTN_OUT_NORM,    # g_norm on linear-attention layers only (GroupRMSNorm)
        MODEL_TENSOR.FFN_GATE_INP,
        MODEL_TENSOR.FFN_EXP_PROBS_B,
        MODEL_TENSOR.FFN_NORM,
        MODEL_TENSOR.FFN_GATE,
