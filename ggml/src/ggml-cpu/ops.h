...
void ggml_compute_forward_gated_delta_net_fused_cache(const struct ggml_compute_params * params, struct ggml_tensor * dst, float * cache_data, int64_t cache_seq_stride);
